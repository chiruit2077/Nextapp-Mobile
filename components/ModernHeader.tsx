...
export const ModernHeader: React.FC<ModernHeaderProps> = ({
    ...
    return (
      <>
        ...
        <LinearGradient
          ...
          style={[styles.container, isTabletDevice && styles.tabletContainer]}
        >
          {renderContent()}
        </LinearGradient>
      </>
  ...
  if (variant === 'glass') {
    return (
      <>
        ...
        <BlurView intensity={80} style={[styles.container, isTabletDevice && styles.tabletContainer]}>
  ...
  if (variant === 'minimal') {
    return (
      <>
        ...
        <View style={[styles.container, styles.minimal, isTabletDevice && styles.tabletContainer]}>
          {renderContent()}
        </View>
      </>
    );
  ...
  return (
    <>
      ...
      <View style={[styles.container, styles.default, isTabletDevice && styles.tabletContainer]}>
        {renderContent()}
      </View>
    </>
  );
