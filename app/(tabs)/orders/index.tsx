...
export default function OrdersScreen() {
  ...
  const getStatusInfo = (status: string) => {
    ...
    switch (safeStatus) {
      case 'new':
        return {
          icon: <Plus size={isTabletDevice ? 20 : 16} color="#3b82f6" />,
          color: '#3b82f6',
          bgColor: '#dbeafe',
          text: 'New',
        };
      ...
      case 'processing':
        return {
          icon: <Package size={isTabletDevice ? 20 : 16} color="#8b5cf6" />,
          color: '#8b5cf6',
          bgColor: '#ede9fe',
          text: 'Processing',
        };
      ...
      case 'hold':
        return {
          icon: <AlertCircle size={isTabletDevice ? 20 : 16} color="#f59e0b" />,
          color: '#f59e0b',
          bgColor: '#fef3c7',
          text: 'Hold',
        };
      case 'picked':
        return {
          icon: <Package size={isTabletDevice ? 20 : 16} color="#059669" />,
          color: '#059669',
          bgColor: '#dcfce7',
          text: 'Picked',
        };
      case 'dispatched':
        return {
          icon: <Truck size={isTabletDevice ? 20 : 16} color="#8b5cf6" />,
          color: '#8b5cf6',
          bgColor: '#ede9fe',
          text: 'Dispatched',
        };
      ...
      default:
        return {
          icon: <Clock size={isTabletDevice ? 20 : 16} color="#64748b" />,
          color: '#64748b',
          bgColor: '#f1f5f9',
          text: 'Unknown',
        };
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerActions}>
              {canCreateOrder && (
                <TouchableOpacity
                  style={[styles.createButton, isTabletDevice && styles.tabletCreateButton]}
